...
def delete_reservation():
    ...
    # print("selected_id",selected_id.var)
    # if not selected_id:
...
tk.Label(admin_root, text="Name:").grid(row=3, column=0)
name_entry = tk.Entry(admin_root)
tk.Label(admin_root, text="Phone:").grid(row=4, column=0)
phone_entry = tk.Entry(admin_root)
tk.Label(admin_root, text="Destination:").grid(row=5, column=0)
dest_entry = tk.Entry(admin_root)
tk.Label(admin_root, text="Date:").grid(row=6, column=0)
date_entry = tk.Entry(admin_root)
tk.Label(admin_root, text="Airline:").grid(row=7, column=0)
